...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?= base_url();?>assets2/css/bootstrap/bootstrap.css" />
	...
	<body>
					...
					<div class="row">
						<div class="col-md-8 blog-content">
							<p class="lead text-white">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda nihil aspernatur
								nemo sunt, qui, harum repudiandae quisquam eaque dolore itaque quod tenetur quo quos
								labore?
							</p>
							<p class="text-white">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae expedita cumque
								necessitatibus ducimus debitis totam, quasi praesentium eveniet tempore possimus illo
								esse, facilis? Corrupti possimus quae ipsa pariatur cumque, accusantium tenetur
								voluptatibus incidunt reprehenderit, quidem repellat sapiente, id, earum obcaecati.
							</p>
							<p><img src="images/img_1.jpg" alt="Image" class="img-fluid" /></p>

							<blockquote>
								<p class="text-white">
									Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident vero tempora
									aliquam excepturi labore, ad soluta voluptate necessitatibus. Nulla error beatae,
									quam, facilis suscipit quaerat aperiam minima eveniet quis placeat.
								</p>
							</blockquote>

							<p class="text-white">
								Eveniet deleniti accusantium nulla natus nobis nam asperiores ipsa minima laudantium
							...
							<p class="text-white">
								Accusamus, temporibus, ullam. Voluptate consectetur laborum totam sunt culpa repellat,
								dolore voluptas. Quaerat cum ducimus aut distinctio sit, facilis corporis ab vel alias,
								voluptas aliquam, expedita molestias quisquam sequi eligendi nobis ea error omnis
								consequatur iste deleniti illum, dolorum odit.
							</p>
							<p class="text-white">
								In adipisci corporis at delectus! Cupiditate, voluptas, in architecto odit id error
								...
								suscipit. Nisi quo nulla, nihil harum obcaecati vel atque quos.
							</p>
							<p><img src="images/img_2.jpg" alt="Image" class="img-fluid" /></p>
							<p class="text-white">
								Amet sint explicabo maxime accusantium qui dicta enim quia, nostrum id libero voluptates
								quae suscipit dolor quam tenetur dolores inventore illo laborum, corporis non ex,
								debitis quidem obcaecati! Praesentium maiores illo atque error! Earum, et, fugit. Sint,
								delectus molestiae. Totam.
							</p>

							<p class="text-white">
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa iste, repudiandae facere
								aperiam sapiente, officia delectus soluta molestiae nihil corporis animi quos ratione
								qui labore? Sint eaque perspiciatis minus illum.
							</p>
							<p class="text-white">
								Consectetur porro odio quod iure quaerat cupiditate similique, dolor reprehenderit
							...
							<p class="text-white">
								Id similique, rem ipsam accusantium iusto dolores sit velit ex quas ea atque, molestiae.
								Sint, sed. Quisquam, suscipit! Quisquam quibusdam maiores fugiat eligendi eius
						...
						<div class="col-md-4 sidebar">
							...
							<div class="sidebar-box">
								<div class="categories">
									...
									<li>
										<a href="#"> Club News <span>(22)</span></a>
									</li>
									<li>
										<a href="#"> Media Center <span>(37)</span></a>
									</li>
									<li>
										<a href="#"> Vedio <span>(42)</span></a>
									</li>
									<!-- <li>
		...
		<script src="<?= base_url();?>assets2/js/jquery.mb.YTPlayer.min.js"></script>
